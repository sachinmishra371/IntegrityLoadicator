...
namespace ZebecLoadMaster.Models.DAL
{
    public class clsSqlData
    {
        ...
        public static string GetConnectionString()
        {
         ...
         // ConString = "Data Source=" + ServerName + ";Initial Catalog=Saushyant_Stability;Integrated Security=true";
      //  ConString = "Data Source=ZG-26;Initial Catalog=Saushyant_Stability;Integrated Security=true";
         ConString = "Data Source=SACHIN-MISHRA\\SQLEXPRESS;Initial Catalog=Saushyant_Stability;Integrated Security=true";
